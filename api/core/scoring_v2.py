...
def calculate_elimination_score(
    ...
    # yellow (3 puan): Yakın lokasyon  
    # red (0 puan): Uyumsuz lokasyon
    # gray: CV'de veya ilanda lokasyon yok
    if location_score >= 5:
        loc_status = 'green'
    elif location_score >= 3:
        loc_status = 'yellow'
    elif not cand_location or not pos_location:
        loc_status = 'gray'
    else:
        loc_status = 'red'
    ...
    location_status = {
        'status': loc_status,
        'candidate_location': cand_location or '-',
        'position_location': pos_location or '-',
        'match_type': location_detail
    }
