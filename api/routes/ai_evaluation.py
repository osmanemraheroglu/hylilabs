            ...
            if cached:
                ...
                return {
                    ...
                    "data": {
                        ...
                        "eligible": cached.get("eligible", False),
                        "evaluation_method": cached.get("consensus_method", ""),
                        "gemini_score": cached.get("gemini_score", 0),
                        "hermes_score": cached.get("hermes_score", 0),
                        "openai_score": cached.get("openai_score", 0),
                        "models_used": cached.get("models_used", []),
                        "claude_used": cached.get("claude_used", False),
                        "layer_scores": cached.get("scores", {}),
                        "strengths": cached.get("strengths", []),
                        "weaknesses": cached.get("weaknesses", []),
                        "notes": " | ".join(cached.get("notes_for_hr", [])) if cached.get("notes_for_hr") else "",
                        "overall_assessment": cached.get("overall_assessment", ""),
